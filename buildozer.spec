...
title = Mowilex Valve Control

# (str) Package name
package.name = mowilexvalve

# (str) Package domain (needed for android/ios packaging)
package.domain = com.mowilex

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,json,db,sqlite3,html,css,js

# (list) List of inclusions using pattern matching
source.include_patterns = assets/*,templates/*,static/*,media/*

# (list) Source files to exclude (let empty to not exclude anything)
source.exclude_exts = spec,md
source.exclude_dirs = tests,bin,venv,.venv,__pycache__,build,dist,_archived_files
...
#presplash.filename = %(source.dir)s/media/logo/presplash.png
...
services = ModbusService:modbus_service.py
...
# (str) Application loading screen background color (splash screen)
#android.loader_color = #FFFFFF
...
# (str) The format used to package the app for debug mode (apk or aab or aar).
