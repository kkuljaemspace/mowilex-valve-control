...
(function () {
  ...
  function switchImage(style) {
    ...
    switchImagesList.map(function (imageEl) {
      ...
      imageEl.src = '/static/assets/' + 'img/' + setImage; // Using window.assetsPath to get the exact relative path
    });
  }
...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    if (searchInput.length) {
      ...
      var searchData = $.ajax({
        url: '/static/assets/' + 'json/' + searchJson, //? Use your own search api instead
        dataType: 'json',
        async: false
      }).responseJSON;
